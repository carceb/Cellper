...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
    ...
    <tr>
	  ...
	  <td height="20" colspan="3" valign="top"  >&nbsp; <h2> Agregar/Modificar Grupo</h2></td>
    </tr>
    <tr>
          ...
          <table>
                <tr>
                    <td class="auto-style2">
                        <asp:Label Text="Nombre Grupo" ID="Label6" runat="server" />
                    </td>
                    <td class="auto-style2">
                        ...
                        <ASP:RequiredFieldValidator id="rqrValidaNombre" runat="server" errormessage="Debe colocar el nombre del grupo" width="132px" controltovalidate="txtNombre" display="Dynamic"></ASP:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style2">
                        <asp:Label Text="Descripción Grupo" ID="Label5" runat="server" />
                    </td>
                    <td class="auto-style2">
                            <asp:TextBox runat="server" ID="txtDescripcion"  MaxLength="50" Width ="300"/> 
                            <ASP:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" errormessage="Debe colocar la descripción del grupo" width="132px" controltovalidate="txtDescripcion" display="Dynamic"></ASP:RequiredFieldValidator>
                      </td>
                </tr>
               <tr>
