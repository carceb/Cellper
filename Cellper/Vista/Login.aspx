...
BODY {
 ...
 <body>
  ...
  <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#336699">
    <tr>
      <td colspan="4"><img src="../Images/top_helper_2.png" width="1000" height="160"></td>
    </tr>
    <tr>
      <td width="200" rowspan="2" align="left" valign="top" bgcolor="#24496f"> <uc1:UCNavigation id="UserControl1" runat="server"></uc1:UCNavigation></td>
...
<tr>
            ...
            <form id="Form1" runat="server">
                        ...
                        <tr>
                          ...
                          <td height="20" colspan="2" align="right"  valign="middle">
                              <ASP:Button CssClass="boton_formulario" id="btnLogin" runat="server" 
                                  text="ENTRAR" width="86px" onclick="btnLogin_Click"></ASP:Button></td>
                        </tr>
                      </table>
                ...
                <tr>
                  ...
                  <td width="490" height="60" align="center" valign="top" class="auto-style2">Control de Mantenimientos a Equipos e Inventario</td>
